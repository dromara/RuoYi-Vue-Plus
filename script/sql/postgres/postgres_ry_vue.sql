...
insert into sys_menu values(1761400000000000132, '字典数据', 1761400000000000001, 6, 'dict-data/index/:dictId', 'system/dict/data', '', 'N', 'N', 'C', '1', '0', 'system:dict:list', '#', '/system/dict', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
