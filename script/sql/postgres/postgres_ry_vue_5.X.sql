...
insert into sys_menu values('116', '修改生成配置', '3', '2', 'gen-edit/index/:tableId', 'tool/gen/editTable', '', 'N', 'N', 'C', 'N', 'Y', 'tool:gen:edit', '#', '/tool/gen', '', 103, 1, now(), null, null, '');
insert into sys_menu values('130', '分配用户', '1', '2', 'role-auth/user/:roleId', 'system/role/authUser', '', 'N', 'N', 'C', 'N', 'Y', 'system:role:edit', '#', '/system/role', '', 103, 1, now(), null, null, '');
insert into sys_menu values('131', '分配角色', '1', '1', 'user-auth/role/:userId', 'system/user/authRole', '', 'N', 'N', 'C', 'N', 'Y', 'system:user:edit', '#', '/system/user', '', 103, 1, now(), null, null, '');
insert into sys_menu values('132', '字典数据', '1', '6', 'dict-data/index/:dictId', 'system/dict/data', '', 'N', 'N', 'C', 'N', 'Y', 'system:dict:list', '#', '/system/dict', '', 103, 1, now(), null, null, '');
insert into sys_menu values('133', '文件配置管理', '1', '10', 'oss-config/index', 'system/oss/config', '', 'N', 'N', 'C', 'N', 'Y', 'system:ossConfig:list', '#', '/system/oss', '', 103, 1, now(), null, null, '');
