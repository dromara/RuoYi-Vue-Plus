...
public class StartExecuteComponent extends NodeComponent {
    ...
    public void process() {
        ...
        FlowInstance instance = insService.start(context.getBusinessId(), flowParams);
        context.setInstance(instance);
        saveBizExt(context, instance);

        List<FlowTask> taskList = taskService.list(new FlowTask().setInstanceId(instance.getId()));
    ...
    private void saveBizExt(StartProcessContext context, FlowInstance instance) {
